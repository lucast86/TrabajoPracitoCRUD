...
namespace TrabajoPracticoCRUD {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class UsuariosDataTable : global::System.Data.TypedTableBase<UsuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsuariosRow AddUsuariosRow(string nombre, string clave, string mail, string tipo_usuario) {
...
namespace TrabajoPracticoCRUD.DataSet1TableAdapters {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Usuarios] ([nombre], [clave], [mail], [tipo_usuario]) VALUES (" +
                "@nombre, @clave, @mail, @tipo_usuario)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Usuarios] SET [nombre] = @nombre, [clave] = @clave, [mail] = @mail," +
                " [tipo_usuario] = @tipo_usuario WHERE (([id] = @Original_id))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["ITES_1ConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, nombre, clave, mail, tipo_usuario FROM dbo.Usuarios";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT nombre FROM Usuarios where nombre=@nombre and clave=@clave";
        ...
        public virtual int Insert(string nombre, string clave, string mail, string tipo_usuario) {
            if ((nombre == null)) {
        ...
        public virtual int Update(string nombre, string clave, string mail, string tipo_usuario, int Original_id) {
            if ((nombre == null)) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual string LOGIN(string nombre, string clave) {
